...
if __name__ == "__main__":
    ...
    parser.add_argument('--source', type=str, default='dslr',choices=["amazon", "dslr","webcam"])
    parser.add_argument('--target', type=str, default='amazon', choices=["amazon", "dslr", "webcam"])
    ...
    s_dset_path = '/home/hyf/cdfsl/RSDA/data/Office/' + args.source + '_list.txt' #'../../data/office/' + args.source + '_list.txt'
    t_dset_path = '/home/hyf/cdfsl/RSDA/data/Office/' + args.target + '_list.txt' #'../../data/office/' + args.target + '_list.txt'
