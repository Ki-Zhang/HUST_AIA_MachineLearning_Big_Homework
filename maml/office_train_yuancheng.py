...
def main():
    ...
    mini = Office(root='/root/autodl-tmp/office_31'
                  , name='amazon'
                  , n_way=args.n_way
                  , k_shot=args.k_spt
                  , k_query=args.k_qry
    ...
    mini_test = Office(root='/root/autodl-tmp/office_31'
                       , name='dslr'
                       , n_way=args.n_way
                       , k_shot=args.k_spt
                       , k_query=args.k_qry
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--update_step_test', type=int, help='update steps for finetunning', default=7)
